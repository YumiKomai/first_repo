...
This is a time series giving the monthly totals of accidental deaths in the USA. According to the plot, the number of death was maxumum on Jul in every year.
...
## Others
We also make the following plots by using some datas
```{r,echo=FALSE}
plot(UKDriverDeaths)
plot(USArrests)
plot(UKgas)
